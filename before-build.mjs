...
const file_module = path.join(
  __dirname,
  "./node_modules/gojs/release/go-module.js"
);
const file_debug_js = path.join(
  __dirname,
  "./node_modules/gojs/release/go-debug.js"
);
const file_debug_mjs = path.join(
  __dirname,
  "./node_modules/gojs/release/go-debug.mjs"
);
const file_debug_module = path.join(
  __dirname,
  "./node_modules/gojs/release/go-debug-module.js"
);
